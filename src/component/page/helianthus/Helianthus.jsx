...
export default function FeMale() {
  ...
  return (
    <>
      ...
      <div className="text-center h2 pt-5">ĐỒNG GIÁ CHỈ TỪ 49K</div>
      <div className="d-flex flex-wrap mb-center container" style={{ padding: "1%" }}>
        {clothes.filter(e=>e.price*1<400).map((item) => (
          <div
            key={item.id}
